...
class NewsModelTablet extends StatefulWidget {
  final ItemNews itemNews;
  final bool isNewsEdit;
  var height;

  NewsModelTablet({required this.itemNews, required this.isNewsEdit, required this.height});

  @override
  State<NewsModelTablet> createState() => _NewsModelTabletState();
}

class _NewsModelTabletState extends State<NewsModelTablet> {
  @override
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.only(start: 5, top: 10, end: 8),
                              child: Text(
                          ...
                          Expanded(
                            child: Align(
                              alignment: AlignmentDirectional.centerStart,
                              child: Padding(
                                padding: EdgeInsetsDirectional.only(start: 5, top: 5, end: 8, bottom: 5),
                                child: Html(
                                  data: widget.itemNews.description,
                                  style: {
                                    "body": Style(margin: Margins.all(0), maxLines: 2, textOverflow: TextOverflow.fade),
                                  },
                                ),
                              ),
                            ),
